...
def menu():
    ...
    print("\033[1;96m"+50*"-")
    print("\n%s [%s01%s] Crack fb from your own friends listi "%(p,b,p))
    print("%s [%s02%s] Crack fb from public friends list "%(p,b,p))
    print("%s [%s03%s] Crack fb from public followers "%(p,b,p))
    print("%s [%s04%s] from fb from public likes"%(p,b,p))
    print("%s [%s05%s] Crack fb massal publik"%(p,b,p))
    print("%s [%s06%s] Check the cracked list"%(p,b,p))
